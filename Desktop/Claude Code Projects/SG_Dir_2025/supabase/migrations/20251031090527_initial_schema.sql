--
-- Singapore Halal Directory - Production Schema
-- Migration: 20251031090527_initial_schema
--
-- This migration represents the APPLIED PRODUCTION SCHEMA that is currently
-- running in the database. This is the SOURCE OF TRUTH for the project.
--
-- Generated from: pg_dump --schema-only on 2025-01-01
-- Applied to database: 2025-10-31 09:05:27
--
-- Key Features:
-- - Full Stripe integration (one-time charges for featured listings)
-- - Status workflow (pending/approved/rejected for businesses and claims)
-- - Geolocation support (latitude/longitude for mapping)
-- - SEO-friendly slugs for areas and businesses
-- - Automated business count aggregation via triggers
-- - Featured listing expiry tracking
-- - Coupon code support with Stripe integration
-- - Comprehensive claim verification workflow
-- - Row Level Security (RLS) with is_admin boolean pattern
-- - Image upload support (1 for standard, 8 for featured listings)
--
-- Database Version: PostgreSQL 17.4
-- Schema Version: Production (20251031090527)
--
